...
const Footer = () => {
  return (
    <>
      <footer className="bg-[#F1C7A3]/90 text-neutral-700 md:text-xs lg:text-[0.7rem] xl:text-[0.9rem] rounded-t-xl">
        <div className="container mx-auto py-4 px-5 flex flex-row justify-between items-center">
          ...
          <div className="flex md:hidden lg:inline-flex lg:justify-center items-center">
