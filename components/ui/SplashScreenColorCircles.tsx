...
const SplashScreenColorCircles = () => {
  return (
    <div className="h-screen">
      ...
      <div className="absolute left-[1.5rem] top-[8rem] w-32 h-32 bg-sky-300/70 border-[3px] border-zinc-300 rounded-full"></div>
      <div className="absolute right-[-10rem] top-[10rem] bg-[#F29072] border-[3px] w-64 h-64 border-zinc-400 rounded-2xl rotate-45"></div>
      <div className="absolute right-[8rem] top-[80%] w-96 h-96 bg-[#F1C7A3] border-[3px] border-zinc-300 rounded-full"></div>
