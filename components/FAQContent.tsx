...
const FAQContent = () => {
  return (
    <>
      <div className="relative mt-8 faq-container w-full md:w-[24rem] lg:w-[30rem] xl:w-[40rem] max-h-[44.5rem] md:max-h-[65rem] flex-1 flex flex-col rounded-xl border-[3px] border-black shadow-lg shadow-black mb-20 lg:mb-0 md:mt-2.5 lg:mt-0">
        <div className="h-full max-h-[48rem] lg:max-h-[34rem] w-full overflow-y-auto py-6 lg:py-5 lg:-mt-2">
          <div className="absolute right-0 pr-0 top-0 z-90 flex justify-end">
            <MobileFAQQuickLinks />
          </div>
          <h2
            id="getting-started"
