      ...
      <div className="md:max-h-[48rem] mt-4 overflow-y-auto">
        ...
        <article className="w-full mb-3 text-slate-900">
          ...
          <p>
            ...
            individuals and businesses seeking specific services. Whether you're
            looking to hire a freelancer or offer your professional services,
            SkillSeek makes the process seamless and straightforward.
          </p>
        </article>
        ...
        <article className="text-slate-900 mb-3">
          ...
          <ul className="list-disc px-6 space-y-2 pt-3">
            ...
            <li>
              You can explore our paid plans and choose the one that best suits
              your needs.
            </li>
            <li>Once you sign up, you can start using SkillSeek right away.</li>
          </ul>
        </article>
        ...
        <article className="text-slate-900 mb-3">
          <h3 className="text-xl font-semibold">How do I create a service?</h3>
          <ol className="list-decimal px-6 space-y-2 pt-3">
            <li>
            ...
            <li>
              ...
              service. You will receive a &apos;Success&apos; popup message when
        ...
        <article className="text-slate-900 mb-3">
          ...
          <ol className="list-decimal px-6 space-y-2 pt-3">
            <li>
              If you are the author of a service, you can edit it by clicking on
              the green &quot;Four Square&quot; button.
            </li>
            <li>
        ...
        <article className="text-slate-900 mb-3">
          ...
          <ol className="list-decimal px-6 space-y-2 pt-3">
            <li>
              If you are the author of a service, you can delete it by clicking
              on the red &quot;Square with - inside&quot; button.
            </li>
            <li>
        ...
        <article className="text-slate-900 mb-3">
          <ul className="list-disc px-6 space-y-2 pt-3">
            <li>We have a dispute resolution process in place to help you.</li>
            <li>
              You can contact our support team if you encounter any issues.
            </li>
            <li>Providers must meet agreed-upon service standards.</li>
            <li>
              Refund options are available in a case of unsatisfactory service.
            </li>
          </ul>
        </article>
        <h2
        ...
        <article className="text-slate-900 mb-3">
          <ul className="list-disc px-6 space-y-2 pt-3">
            ...
            <li>If you are still having trouble, contact our support team.</li>
