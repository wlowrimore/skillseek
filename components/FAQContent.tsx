...
const FAQContent = () => {
  return (
    <>
      <div className="relative mt-8 faq-container w-full md:w-[24rem] lg:w-[30rem] xl:[40rem] max-h-[44.5rem] md:max-h-[65rem] flex-1 flex flex-col rounded-xl border-[3px] border-black shadow-lg shadow-black mb-20 md:mt-2.5">
        <div className="md:max-h-[48rem] w-full overflow-y-auto py-6">
