...
const FAQContent = () => {
  return (
    <>
      <div className="relative mt-4 faq-container w-full md:w-[24rem] lg:w-[30rem] xl:w-[40rem] max-h-[80vh] md:max-h-[65rem] flex-1 flex flex-col rounded-xl border-t md:border-[3px] border-black md:shadow-lg md:shadow-black mb-10 lg:mb-0 md:mt-0 lg:mt-0">
        <div className="md:max-h-[34rem] lg:max-h-[34rem] w-full overflow-y-auto py-12 lg:py-5">
          ...
          <article className="text-slate-900 mb-3">
            <ul className="list-disc px-6 space-y-2 pt-3">
              <li>Email: support@skillseekapp.com</li>
          ...
          <article className="text-slate-900 mb-3">
            <ul className="list-disc px-6 space-y-2 pt-3">
              ...
              <li>Contact support@skillseekapp.com if issues persist.</li>
            </ul>
          </article>
